    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <div class="row mt-3">
                    <div class="col-lg-12">
                        <form action="{{route('kegiatanAdd')}}" method="POST" enctype="multipart/form-data">
                        	@csrf
                        	
                            <div class="mb-3">
                                <label for="simpleinput" class="form-label">Nama Kegiatan</label>
                                <input type="text" name="nama_kegiatan" id="simpleinput" class="form-control">
                            </div>

                            <div class="mb-3">
                                <label for="example-date" class="form-label">Tanggal Kegiatan</label>
                                <input class="form-control" id="example-date" type="date" name="tanggal_kegiatan">
                            </div>
