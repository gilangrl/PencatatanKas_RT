	...
	<div class="card">
		<div class="card-body">
			<form action="" method="get">
                ...
                <div class="row">
                	<div class="col-lg-12">
                        <a href="" onclick="this.href='/cetakPembayaranPertanggal/'+ document.getElementById('startDate').value + '/' + document.getElementById('endDate').value " target="_blank" class="col-md-12 btn btn-primary">Cetak Pertanggal <i class="fa-solid fa-print"></i></a>
                    </div>
                </div>
            </form>
		</div>
